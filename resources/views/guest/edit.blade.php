                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('guest.update', $guest->id) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="col-sm-6 form-control" name="code" value="{{ old('code', $guest->code) }}" placeholder="顧客コード" required>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="name" value="{{ old('name', $guest->name) }}" placeholder="顧客名" required>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="name_kana" name="name_kana" value="{{ old('name_kana', $guest->name_kana) }}" placeholder="顧客名（カナ）">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="col-sm-6 form-control" name="zip_code" value="{{ old('zip_code', $guest->zip_code) }}" placeholder="郵便番号">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="address" value="{{ old('address', $guest->address) }}" placeholder="住所">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="building_name" value="{{ old('building_name', $guest->building_name) }}" placeholder="建物名">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="col-sm-6 form-control" name="tel" value="{{ old('tel', $guest->tel) }}" placeholder="TEL">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="col-sm-6 form-control" name="fax" value="{{ old('fax', $guest->fax) }}" placeholder="FAX">
                            </div>
